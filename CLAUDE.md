...
- Plan of record: `plan-v6/PLAN.md` (v6.1). **Done: E1** (`a79c162`), **E2** (`3333d8c`), **E3a** (`4372e26` fold+C2), **E3b** (`b8588a4` C3 split), **E4a** (`995c625` intel FK). **Next: E5** (compile hygiene: L57, extract template, debounce, tools/lib/load.py; E5b split already done in E3b). Then merge to main once L1–L3 green.
