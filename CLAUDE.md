...
- Plan of record: `plan-v6/PLAN.md` (v6.1). **Done: E1** (`a79c162`), **E2** (`3333d8c`). **Next: E3** (fold UI to the 59-cat spine + C1 card rollup + ship default-only HTML). Paste its §9 ticket header.
