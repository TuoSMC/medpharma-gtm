...
- Plan of record: `plan-v6/PLAN.md` (v6.1). **Done: E1** (`a79c162`), **E2** (`3333d8c`), **E3a** (`4372e26` fold+C2), **E3b** (`b8588a4` C3 split). **Next: E4a** (intel `vendor_id` FK). Paste its §9 ticket header. (Then E5 hygiene; E5b split already done in E3b.)
