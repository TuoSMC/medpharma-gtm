...
header{padding:var(--s6) 22px;border-bottom:1px solid var(--line);background:var(--panel);position:sticky;top:0;z-index:5}
...
nav{display:flex;gap:var(--s1);flex-wrap:wrap;padding:var(--s4) 22px 0;background:var(--panel);border-bottom:1px solid var(--line);position:sticky;top:61px;z-index:5}
